              ...
              <div class="border-t border-gray-200">
                <dl>
                  ...
                  <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{selectedPlayer().weightPounds} lbs</dd>
                  </div>
                  ...
                  <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-6">
                    <div>
                      <div class="mb-3">
                        ...
                        <span class="block text-sm text-gray-900">{selectedPlayer().speed}</span>
                      </div>
                      <div class="mb-3">
                        <span class="block text-sm font-medium text-gray-700">Acceleration</span>
                        <span class="block text-sm text-gray-900">{selectedPlayer().acceleration}</span>
                      </div>
                    </div>
                    <div>
                      <div class="mb-3">
                        <span class="block text-sm font-medium text-gray-700">Strength</span>
                        <span class="block text-sm text-gray-900">{selectedPlayer().strength}</span>
                      </div>
                      <div class="mb-3">
                        <span class="block text-sm font-medium text-gray-700">Agility</span>
                        <span class="block text-sm text-gray-900">{selectedPlayer().agility}</span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                      ...
                      <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                        <ul class="border border-gray-200 rounded-md divide-y divide-gray-200">
                          <For each={selectedPlayer().loadouts}>
                            {loadout => (
