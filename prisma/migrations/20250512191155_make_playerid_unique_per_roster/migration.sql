...
CREATE TABLE "new_PlayerLoadout" (
    ...
    CONSTRAINT "PlayerLoadout_playerId_fkey" FOREIGN KEY ("playerId") REFERENCES "Player" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "PlayerLoadout_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("userId") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_PlayerLoadout" ("loadoutCategory", "loadoutType", "playerId", "playerLoadoutId", "userId") SELECT "loadoutCategory", "loadoutType", "playerId", "playerLoadoutId", "userId" FROM "PlayerLoadout";
